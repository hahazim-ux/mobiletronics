...
@keyframes pulse {
    ...
    <div class="section-title">
      ...
      <div class="holiday-notice">
          ...
          <h4>Holiday Hours</h4>
          <p>Our hours may vary during Malaysian public holidays. Please check our social media channels or call ahead to confirm our operating hours during holidays.</p>
      </div>
  </div>
</section>
     ...
     <section class="content-section">
            ...
            <div class="map-container">
                <div class="map-overlay">
                    <img src="map.png" alt="Malaysia Map">
                    <!-- Location Pins -->
                   
                    <!-- Tooltips -->
                    <div class="location-tooltip" id="kl-tooltip">Kuala Lumpur Flagship Store</div>
                    <div class="location-tooltip" id="penang-tooltip">Penang Branch</div>
                    <div class="location-tooltip" id="johor-tooltip">Johor Bahru Branch</div>
                </div>
            </div>
</section>
